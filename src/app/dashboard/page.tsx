        ...
        <Card shadow="sm" padding="lg" radius="md" withBorder>
            <SimpleGrid cols={2} mt="md">
                ...
                <ActionIcon.Group ml="auto">
                    <CopyButton value={`https://diplom.u-hu.site/${initialValues._id}/goal`} timeout={2000}>
                        {({ copied, copy }) => (
                    ...
                    <CopyButton value={`https://diplom.u-hu.site/${initialValues._id}/alert`} timeout={2000}>
                        {({ copied, copy }) => (
