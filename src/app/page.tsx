...
import { FaChartLine, FaMoneyBillWave, FaShieldAlt, FaUserFriends } from "react-icons/fa";
      ...
      <Container size="lg">
        ...
        >
          <div style={{ flex: 1, maxWidth: '600px' }}>
            ...
            <Group mt={30}>
              <Button component={Link} href={url} size="lg" radius="md">
                Войти через YooMoney
              </Button>
              <Button component={Link} href="#features" variant="light" size="lg" radius="md">
                Узнать больше
              </Button>
            </Group>
          </div>
          <div style={{ flex: 1, maxWidth: '500px' }}>
            <Image
              ...
              alt="Финансовая иллюстрация"
              fallbackSrc="https://placehold.co/500x400?text=Финансовый+помощник"
            />
          </div>
        </Flex>
        ...
        <Card withBorder shadow="md" radius="md" p="xl" my={50} bg="blue.0">
          <Stack align="center" gap="md">
            ...
            <Button component={Link} href={url} size="lg" radius="md" mt="md">
              Войти через YooMoney
            </Button>
          </Stack>
        </Card>
